...
def TEST_tropical_semidirect_attack(n, minM, maxM, num, n_it):
	...
	print("As Eve, success rate and time spent to attack the semidirect-product protocol")
...
""" * The test with the suggested parameters:
		TEST_tropical_semidirect_attack(10,-10^3,10^3,200,5)
"""
